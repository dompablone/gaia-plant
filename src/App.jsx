    ...
    <Card>
      ...
      <form onSubmit={handleSignup}>
        ...
        <div style={{ marginTop: 12 }}>
          <Link to="/login" style={{ opacity: 0.8 }}>Já tenho conta</Link>
        </div>
  ...
  return (
    <Card>
      ...
      <form onSubmit={handleLogin}>
        ...
        <div style={{ marginTop: 12 }}>
          <Link to="/criar-conta" style={{ opacity: 0.8 }}>Não tenho conta</Link>
        </div>
...
function ClinicalProfile({ session, profile, onProfileSaved }) {
  ...
  return (
    <Card>
      ...
      <p style={{ marginTop: 6, opacity: 0.75 }}><b>IMPORTANTE</b> — Não abrevie essas informações.</p>
...
function AppDashboard({ session, profile }) {
  ...
  const cards = [
    {
      title: "Conteúdos",
      desc: "Artigos, vídeos e guias para sua jornada.",
      to: "/app/conteudos",
    },
    {
      title: "Produtos",
      desc: "Catálogo e compras (em breve).",
      to: "/app/produtos",
    },
    {
      title: "Médicos credenciados",
      desc: "Encontre profissionais habilitados (em breve).",
      to: "/app/medicos",
    },
    {
      title: "Meu perfil",
  ...
  return (
    <div style={{ display: "grid", gap: 16 }}>
      <Card>
        <h2 style={{ margin: 0, fontSize: 26 }}>Gaia Plant</h2>
...
function Medicos() {
  return (
    <Card>
      ...
      <p style={{ opacity: 0.75 }}>Lista e filtros de médicos (placeholder).</p>
    </Card>
  );
}
...
export default function App() {
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      <div className="max-w-md mx-auto rounded-xl bg-white shadow p-6">
